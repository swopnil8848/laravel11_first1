...
const SideNav = () => {
    ...
    return (
        <div className={`container fixed top-[${window.innerHeight}] lg:static overflow-x-scroll lg:overflow-auto justify-around bottom-0 z-30 flex lg:flex-col  lg:mb-12 lg:w-1/12 mb-4 `}>
            ...
            <Link href={route('contact.index')} className='mx-auto'><button className={`${select === '/contact' ? 'bg-white text-gray-700' : 'text-white bg-gray-700'} hover:text-gray-700 hover:bg-white text-3xl p-3 rounded-[16px] mx-2 lg:mx-0 my-2`}><MdOutlinePersonOutline /></button></Link>
