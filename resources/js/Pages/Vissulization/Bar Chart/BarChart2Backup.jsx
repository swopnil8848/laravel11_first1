import { select, scaleLinear, axisBottom, scaleBand } from "d3";
...
const BarChart2 = ({ props }) => {
  ...
  // Sample image URLs
  const icons = [
    'https://via.placeholder.com/20', // Example placeholder image
    'https://via.placeholder.com/20', // Example placeholder image
    'https://via.placeholder.com/20', // Example placeholder image
    'https://via.placeholder.com/20', // Example placeholder image
    'https://via.placeholder.com/20', // Example placeholder image
  ...
  useEffect(() => {
    ...
    const xAxis = axisBottom(xScale)
      ...
      .tickPadding(10) // Add some padding to the labels
      .tickFormat((d, i) => icons[i]); // Use icons as labels
    ...
    svg
      ...
      .call(g => {
        ...
        g.selectAll(".tick line").remove(); // Remove the tick lines

        // Append images instead of text labels
        g.selectAll(".tick text").remove();
        g.selectAll(".tick")
          .append("image")
          .attr("xlink:href", (d, i) => icons[i])
          .attr("width", 20)
          .attr("height", 20)
          .attr("x", -10)
          .attr("y", 10);
  ...
  }, [height, width, data, xScale, yScale, icons]);
